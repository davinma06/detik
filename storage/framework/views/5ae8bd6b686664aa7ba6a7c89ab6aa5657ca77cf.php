    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <?php if(isset($data)): ?>
                    <form method="POST" action="<?php echo e(route('article.update', $data->id)); ?>" enctype="multipart/form-data">
                    ...
                    <?php endif; ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="article_title" type="text" class="form-control" name="article_title" value="<?php echo e(isset($data) ? $data->article_title : ''); ?>" required autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="article_content" class="form-control" name="article_content" rows="5" required autofocus><?php echo e(isset($data) ? $data->article_content : ''); ?></textarea>
                            </div>
                        </div>
