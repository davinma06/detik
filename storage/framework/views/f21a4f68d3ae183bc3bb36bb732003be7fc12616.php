                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="vertical-align : middle;text-align:center;">
                                    <div>
                                        <p><?php echo e($value->article_title); ?></p>
                                        <div style="margin-left: 20px">
                                        <img class="img-responsive" src="<?php echo e(Storage::url($value->article_image_preview)); ?>" style="width: 300px;"></img>
                                        </div>
                                        <div>
                                            <p><?php echo e($value->article_content); ?></p>
                                        </div>
                                        <span>Posted by <?php echo e($value->name); ?></span>
                                        <p><?php echo e(date('d M Y',strtotime($value->created_at))); ?></p>
                                    </div>
                                </td>
                            </tr>
